...
class TagQuotesExtractor(SimpleSource):
    ...
    def make_url(self, row, _type):
        ...
        return f"https://quotes.toscrape.com/tag/{self.tag}/page/{page}/", page
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                for e in soup.find_all(class_="quote"):
                    ...
                    rows.append({
                        "uri": f'https://quotes.toscrape.com/tag/{self.tag}/#{sha1(quote_text)}',
                        "tag": self.tag,
